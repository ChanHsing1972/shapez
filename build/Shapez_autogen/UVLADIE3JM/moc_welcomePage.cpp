...
QT_MOC_LITERAL(3, 23, 8), // "loadGame"
QT_MOC_LITERAL(4, 32, 12), // "saveFileName"
QT_MOC_LITERAL(5, 45, 14), // "onStartClicked"
QT_MOC_LITERAL(6, 60, 13), // "onLoadClicked"
QT_MOC_LITERAL(7, 74, 13) // "onExitClicked"

    },
    "WelcomePage\0startGame\0\0loadGame\0"
    "saveFileName\0onStartClicked\0onLoadClicked\0"
    "onExitClicked"
};
...
void WelcomePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->loadGame((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WelcomePage::startGame)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WelcomePage::loadGame)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void WelcomePage::startGame()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void WelcomePage::loadGame(const QString & _t1)
{
